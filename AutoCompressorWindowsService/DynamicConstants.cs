...
namespace AutoCompressorWindowsService
{
    class DynamicConstants
    {
        ...
        public static int checkCompressionTimeInterval = 1 * 1000; //interval = 1 minute

        //to record the txt file that contains the user's settings of the AutoCompressorWindowsService
        //run on 鈴木さんPC
        public static string userAutoCompressorSettingsTxtFile = @"C:\AutoCompressorWindowsService\ユーザー操作\自動圧縮設定.txt";
        /*
        ...
        */
        ...
        //to record the txt file that contains the user's settings of the AutoCompressorWindowsService
        //run on 鈴木さんPC
        public static string backupDictJSONFile = @"C:\AutoCompressorWindowsService\ユーザー操作\圧縮済みフォルダー記録.json";
        ...
        */
        ...
        //毎日圧縮するフォルダ数の最大限
        public static int oneDayMaxCompressFolderNum = 30;
